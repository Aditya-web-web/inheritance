module.exports.Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          <div class="header">Complete Your Signup Process</div>
          <div class="content">
              <p>Hello,</p>
              <p>To complete the signup pocess, enter the code given below:</p>
              <span class="verification-code">{verificationCode}</span>
              <p>If you have any questions, feel free to contact our support team.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Scorevision. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
